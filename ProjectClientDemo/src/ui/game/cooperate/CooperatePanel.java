...
public class CooperatePanel extends JPanel {
	...
	private int state = 0;// 状态 0 未选定 1 选定 2交换中 3消除下落中 4结束 5被动
	private int pre_x = -1;
	...
	@SuppressWarnings("unused")
	private CooperateGamePanel frame;

	public CooperatePanel(String playerID, GameLogicService gs,
			CooperateGamePanel frame) {
	...
	void getRenew() {
		...
		case "Moved":
			...
			me.list.remove(0);
			exlist = me.list;
			swap(que2.get(0), que2.get(1), true);
			break;
		case "Prop":
			exlist = me.list;
