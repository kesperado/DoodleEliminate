...
public class BattleRoom
{
	...
	// 成员Team列表
	private HashMap<String, Boolean> team = new HashMap<String, Boolean>();
	...
	public BattleRoom(int number) throws RemoteException
	{
		this.id = number;
		this.alive = true;
		this.start = false;
	...
	public BattleRoom(int number, String playerID, Listener l)
	...
	public boolean changeTeam(String ID) throws RemoteException
	{
		boolean result = true;
		team.put(ID,!team.get(ID));
		return result;
	}
	...
	public boolean deletePlayer(String playerID) throws RemoteException
	{
		...
		/*
		 * if (players.get(playerID)) { gamelisteners.remove(playerID); }
		 */
		gamelisteners.remove(playerID);
	...
	// 获取房间信息
	public BattleRoomPO getRoomInformation() throws RemoteException
	{
		BattleRoomPO result = new BattleRoomPO();
		result.id = this.id;
		result.roomMaster = this.roomMaster;
		result.setting = this.setting;
		result.players = (HashMap<String, Boolean>) players.clone();
		result.team=(HashMap<String, Boolean>) this.team.clone();
		result.gls = this.gls;
