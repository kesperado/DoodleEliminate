...
public class CoopGameController extends UnicastRemoteObject implements
		GameLogicService
{
	// 游戏ID
	private int gameID;
	...
	// 构造器
	public CoopGameController(int ID) throws RemoteException
	{
		super();
	...
	// 有设置的构造器
	public CoopGameController(int ID, GameSettingPO setting)
