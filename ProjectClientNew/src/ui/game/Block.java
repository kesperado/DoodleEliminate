...
public class Block {
	...
	private int state = 0;// 0正常 2点击 3爆炸 4提示
	...
	public void init(int i, int x, int y) {
		this.number = i;
		s1 = new ImageIcon("image/game/" + number + ".png");
		s3 = new ImageIcon("image/game/" + (number + 100) + ".png");
		s4 = new ImageIcon("image/game/" + (number + 150) + ".png");
		s5 = new ImageIcon("image/game/" + (number + 200) + ".png");
		xzb = y * 50 + 20;
		yzb = x * 50 + 20;
		state = 0;
	}
